    ...
    <div class="logoBar">
        <div class="comWidth">
            ...
            <div class="search_box fl">
                ...
                <a href="${pageContext.request.contextPath }/page/select"><input type="button" value="搜 索" class="search_btn fr"></a>
            </div>
            ...
            <div class="shopClass fl">
                ...
                <div class="shopClass_show">
                    <dl class="shopClass_item">
                        <dt><a href="${pageContext.request.contextPath }/page/categories" class="b">手机</a><a href="${pageContext.request.contextPath }/page/categories" class="b">数码</a> <a href="${pageContext.request.contextPath }/page/categories" class="aLink">合约机</a>
                        </dt>
