    ...
    <div class="navBox">
        <div class="comWidth">
            ...
            <ul class="nav fl">
                ...
                <li><a href="${pageContext.request.contextPath }/page/categories">减肥瘦身</a></li>
        ...
        <div class="leftNav">
            ...
            <div class="nav_cont">
                ...
                <ul class="navCont_list clearfix">
                    <li><a href="${右侧进入药品主页 }">示例药品</a></li>
                    <li><a href="${右侧进入药品主页 }">示例药品</a></li>
                    <li><a href="${右侧进入药品主页 }">示例药品</a></li>
                    <li><a href="${右侧进入药品主页 }">示例药品</a></li>
                    <li><a href="${右侧进入药品主页 }">示例药品</a></li>
                    <li><a href="${右侧进入药品主页 }">示例药品</a></li>
                    <li><a href="${右侧进入药品主页 }">全部手机</a></li>
                </ul>
            </div>
            <div class="nav_cont">
                <h3>药品分类2</h3>
    ...
    <div class="rightArea">
        ...
        <div class="products_list clearfix">
            <div class="item">
                <div class="item_cont">
                    <div class="img_item">
                        <a href="introduction.jsp"><img src="${pageContext.request.contextPath }/images/shopImg.png" alt="shopImg"></a>
                    </div>
                    <p><a>汤臣倍健液体钙软胶囊</a></p>

                    <p class="money">$888</p>

                    <p>评论:<span></span><span></span><span></span><span></span><span></span><a>(78条)</a></p>
                </div>
            </div>
            <div class="item">
                <div class="item_cont">
